...
| `output=profile.speedscope.json` | Write the profile to this file instead of stderr |
...
generated `profile.speedscope.json`, or load the pre-generated
[profile.speedscope.json](profile.speedscope.json) from this directory.
